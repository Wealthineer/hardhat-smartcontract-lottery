    ...
    : describe("Lottery Unit Test", function () {
          ...
          describe("constructor", async function () {
              it("initializes the lottery correctly", async function () {
                  ...
                  assert.equal(lotteryState.toString(), "0") //"0" is OPEN and "1" is CALCULATING
              ...
              it("picks a winner, resets the lottery, and sends money", async function () {
                  ...
                  await new Promise(async (resolve, reject) => {
                      lottery.once("WinnerPicked", async () => {
                          try {
                              const recentWinner = await lottery.getRecentWinner() //winner in this text deterministic - so we know which balance we need to look at
                              const lotteryState = await lottery.getLotteryState()
                              ...
                              assert.equal(
                                  ...
                                  winnerStartingBalance
                                      .add(
                                          lotteryEntranceFee
                                              .mul(additionalEntrants) //entrants
                                              .add(lotteryEntranceFee) //entry of deployer in beforeEach
                                      )
                                      .toString()
                              )
                          } catch (e) {
                      ...
                      //below we will fire the event and the listener will resolve
                      const tx = await lottery.performUpkeep([])
